...
let rand = randomIntFromInterval(19, 120); // global scope

// we'll need to store the values generated by random number, for each crystal
let gar = randomIntFromInterval(1, 12);
let eme = randomIntFromInterval(1, 12);
let sap = randomIntFromInterval(1, 12);
let ame = randomIntFromInterval(1, 12);
