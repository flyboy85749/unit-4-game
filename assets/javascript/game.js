...
var gar = randomIntFromInterval(1,40);
// console.log(gar);

var eme = randomIntFromInterval(1,40);
// console.log(eme);

var sap = randomIntFromInterval(1,40);
// console.log(sap);

var ame = randomIntFromInterval(1,40);
// console.log(ame);
...
function startGame() {
    ...
    $(".gar-value").css({"display": "none"});
    $(".eme-value").css({"display": "none"});
    $(".sap-value").css({"display": "none"});
    $(".ame-value").css({"display": "none"});
}
startGame();
...
// these four add random numbers to the screen
